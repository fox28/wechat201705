...
public class UserDao {
	...
	// currentAppUser数据库字段名
	// name nick avatar_Id avatar_name avatarPath avatarType avatarUpdateTime
	...
	public void saveContactList(List<EaseUser> contactList) {
	    WeChatDBManager.getInstance().saveContactList(contactList);
	}
	...
	public Map<String, EaseUser> getContactList() {
	    ...
	    return WeChatDBManager.getInstance().getContactList();
	}
	...
	public void deleteContact(String username){
	    WeChatDBManager.getInstance().deleteContact(username);
	}
	...
	public void saveContact(EaseUser user){
	    WeChatDBManager.getInstance().saveContact(user);
	}
	
	public void setDisabledGroups(List<String> groups){
	    WeChatDBManager.getInstance().setDisabledGroups(groups);
    }
    
    public List<String>  getDisabledGroups(){       
        return WeChatDBManager.getInstance().getDisabledGroups();
    }
    
    public void setDisabledIds(List<String> ids){
        WeChatDBManager.getInstance().setDisabledIds(ids);
    }
    
    public List<String> getDisabledIds(){
        return WeChatDBManager.getInstance().getDisabledIds();
    }
    
    public Map<String, RobotUser> getRobotUser(){
    	return WeChatDBManager.getInstance().getRobotList();
    }
